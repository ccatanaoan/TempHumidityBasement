...
B4R::Common::LogHelper(1,102,F("AppStart"));
 //BA.debugLineNum = 88;BA.debugLine="Dim bb() As Byte = \"BasementTempHumid\"";
...
B4R::Common::LogHelper(1,102,F("Connected to broker"));
 //BA.debugLineNum = 124;BA.debugLine="MQTT.Subscribe(\"TempHumidBasement\", 0)";
b4r_main::_mqtt->Subscribe(be_ann54_4.wrap("TempHumidBasement"),(Byte) (0));
...
B4R::Common::LogHelper(4,102,F("Message arrived. Topic="),101,_topic->data,102,F(" Payload="),100,be_ann60_8.wrapPointer(_payload));
 //BA.debugLineNum = 133;BA.debugLine="If Topic = \"TempHumidBasement\" Then";
if ((_topic)->equals(be_ann61_3.wrap("TempHumidBasement"))) { 
...
if ((_payload)->equals((be_ann62_3.wrap("Restart controller"))->GetBytes())) { 
 //BA.debugLineNum = 135;BA.debugLine="MQTT.Publish(\"TempHumidBasement\",\"*Restarting r";
b4r_main::_mqtt->Publish(be_ann63_4.wrap("TempHumidBasement"),(be_ann63_6.wrap("*Restarting relay by remote"))->GetBytes());
...
b4r_main::_mqtt = &be_gann7_3;
 //BA.debugLineNum = 63;BA.debugLine="Private MQTTHostName As String = \"broker.emqx.io\"";
...
const UInt cp = B4R::StackMemory::cp;
 //BA.debugLineNum = 207;BA.debugLine="Public Sub ReadSensor";
 //BA.debugLineNum = 209;BA.debugLine="RunNative(\"setup\",Null)";
Common_RunNative(setup,Common_Null);
 //BA.debugLineNum = 210;BA.debugLine="ReadWeather(0)";
_readweather((Byte) (0));
...
B4R::B4RString be_ann105_3;
B4R::B4RString be_ann106_4;
B4R::B4RString* _s = B4R::B4RString::EMPTY;
B4R::B4RString be_ann110_12;
B4R::B4RString be_ann110_16;
B4R::B4RString be_ann110_20;
B4R::B4RString be_ann110_24;
B4R::B4RString be_ann110_28;
B4R::B4RString be_ann110_32;
B4R::B4RString be_ann110_36;
B4R::B4RString be_ann110_54;
B4R::B4RString be_ann110_72;
B4R::B4RString be_ann110_90;
B4R::B4RString be_ann110_108;
B4R::B4RString be_ann110_126;
B4R::B4RString* be_ann110_143e1[25];
B4R::Array be_ann110_143e2;
...
if (b4r_main::_wifi->getIsConnected()) { 
 //BA.debugLineNum = 184;BA.debugLine="Log(\"Temp from DHT22: \",DHT22Temp)";
B4R::Common::LogHelper(2,102,F("Temp from DHT22: "),7,(double)(b4r_main::_dht22temp));
 //BA.debugLineNum = 185;BA.debugLine="If localstate = \"OK\" And IsNumber(DHT22Temp) The";
if ((_localstate)->equals(be_ann105_3.wrap("OK")) && B4R::__c->IsNumber(B4R::B4RString::fromNumber((Double)(b4r_main::_dht22temp)))) { 
 //BA.debugLineNum = 187;BA.debugLine="timelib.initialize(\"pool.ntp.org\",0)";
b4r_main::_timelib->initialize(be_ann106_4.wrap("pool.ntp.org"),0);
 //BA.debugLineNum = 188;BA.debugLine="timestamp = timelib.timestamp";
b4r_main::_timestamp = b4r_main::_timelib->timestamp();
 //BA.debugLineNum = 189;BA.debugLine="If timestamp <> 0 Then";
if (b4r_main::_timestamp!=0) { 
 //BA.debugLineNum = 190;BA.debugLine="Dim s As String";
_s = B4R::B4RString::EMPTY;
 //BA.debugLineNum = 191;BA.debugLine="s = JoinStrings(Array As String(localstate,\"|\"";
_s = B4R::__c->JoinStrings(be_ann110_143e2.create(be_ann110_143e1,25,100,_localstate,be_ann110_12.wrap("|"),B4R::B4RString::fromNumber((Double)(b4r_main::_dht22temp)),be_ann110_16.wrap("|"),B4R::B4RString::fromNumber((Double)(b4r_main::_dht22hum)),be_ann110_20.wrap("|"),B4R::B4RString::fromNumber((Long)(b4r_main::_dht22perception)),be_ann110_24.wrap("|"),B4R::B4RString::fromNumber((Long)(b4r_main::_dht22comfortstatus)),be_ann110_28.wrap("|"),B4R::B4RString::fromNumber((Double)(b4r_main::_dht22heatindex)),be_ann110_32.wrap("|"),B4R::B4RString::fromNumber((Double)(b4r_main::_dht22dewpoint)),be_ann110_36.wrap("|"),B4R::__c->NumberFormat(b4r_main::_timelib->getyear(b4r_main::_timestamp),(Byte) (2),(Byte) (0)),be_ann110_54.wrap("-"),B4R::__c->NumberFormat(b4r_main::_timelib->getmonth(b4r_main::_timestamp),(Byte) (2),(Byte) (0)),be_ann110_72.wrap("-"),B4R::__c->NumberFormat(b4r_main::_timelib->getday(b4r_main::_timestamp),(Byte) (2),(Byte) (0)),be_ann110_90.wrap("|"),B4R::__c->NumberFormat(b4r_main::_timelib->gethour(b4r_main::_timestamp),(Byte) (2),(Byte) (0)),be_ann110_108.wrap(":"),B4R::__c->NumberFormat(b4r_main::_timelib->getminute(b4r_main::_timestamp),(Byte) (2),(Byte) (0)),be_ann110_126.wrap(":"),B4R::__c->NumberFormat(b4r_main::_timelib->getseconds(b4r_main::_timestamp),(Byte) (2),(Byte) (0))));
 //BA.debugLineNum = 195;BA.debugLine="Log(\"TempHumidBasement to MQTT: \",s)";
B4R::Common::LogHelper(2,102,F("TempHumidBasement to MQTT: "),101,_s->data);
 //BA.debugLineNum = 196;BA.debugLine="MQTT.Publish(\"TempHumidBasement\",s)";
b4r_main::_mqtt->Publish(be_ann112_4.wrap("TempHumidBasement"),(_s)->GetBytes());
 };
 };
 };
 //BA.debugLineNum = 202;BA.debugLine="If tag = 0 Then";
if (_tag==0) { 
 //BA.debugLineNum = 203;BA.debugLine="CallSubPlus(\"ReadWeather\",60000,0)";
