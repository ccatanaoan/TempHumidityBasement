...
B4R::Common::LogHelper(1,102,F("AppStart"));
 //BA.debugLineNum = 86;BA.debugLine="Dim bb() As Byte = \"BasementTempHumid\"";
_bb = (be_ann31_8.wrap("BasementTempHumid"))->GetBytes();
 //BA.debugLineNum = 87;BA.debugLine="RunNative(\"SetHostName\", bb)";
Common_RunNative(SetHostName,be_ann32_6.wrapPointer(_bb));
 //BA.debugLineNum = 92;BA.debugLine="pin16.Initialize(16, pin16.MODE_OUTPUT)";
b4r_main::_pin16->Initialize((Byte) (16),Pin_MODE_OUTPUT);
 //BA.debugLineNum = 93;BA.debugLine="d6.Initialize(d1pins.D6, d6.MODE_OUTPUT)";
b4r_main::_d6->Initialize(b4r_main::_d1pins->D6,Pin_MODE_OUTPUT);
 //BA.debugLineNum = 96;BA.debugLine="ConnectToWifi";
_connecttowifi();
 //BA.debugLineNum = 99;BA.debugLine="Dim ClientId As String = Rnd(0, 999999999) 'creat";
_clientid = B4R::B4RString::fromNumber((Long)(Common_Rnd((Long) (0),(Long) (999999999))));
 //BA.debugLineNum = 100;BA.debugLine="MQTT.Initialize2(WiFiStr.stream, MQTTHostName, MQ";
b4r_main::_mqtt->Initialize2(b4r_main::_wifistr->getStream(),b4r_main::_mqtthostname,(UInt) (b4r_main::_mqttport),_clientid,_mqtt_messagearrived,_mqtt_disconnected);
 //BA.debugLineNum = 101;BA.debugLine="MQTT_Connect(0)";
_mqtt_connect((Byte) (0));
 //BA.debugLineNum = 104;BA.debugLine="DHT22pin.Initialize(d3pins.D3, DHT22pin.MODE_INPU";
...
B4R::Common::LogHelper(4,102,F("Connected to "),101,b4r_main::_wifissid->data,102,F(" network, Local IP "),101,b4r_main::_wifi->getLocalIp()->data);
 ...
 //BA.debugLineNum = 156;BA.debugLine="Log(\"Connecting to WiFi\")";
B4R::Common::LogHelper(1,102,F("Connecting to WiFi"));
 //BA.debugLineNum = 157;BA.debugLine="If WiFi.Connect2(WiFiSSID, WiFiPassword) = False";
if (b4r_main::_wifi->Connect2(b4r_main::_wifissid,b4r_main::_wifipassword)==Common_False) { 
 //BA.debugLineNum = 158;BA.debugLine="ConnectToWifi";
_connecttowifi();
 };
 };
...
if (b4r_main::_mqtt->Connect()==Common_False) { 
 //BA.debugLineNum = 114;BA.debugLine="Log(\"Not connected to broker\")";
B4R::Common::LogHelper(1,102,F("Not connected to broker"));
 //BA.debugLineNum = 115;BA.debugLine="MQTT.Connect";
...
B4R::Common::LogHelper(1,102,F("Connected to broker"));
 //BA.debugLineNum = 120;BA.debugLine="MQTT.Subscribe(\"TempHumidBasement\", 0)";
b4r_main::_mqtt->Subscribe(be_ann52_4.wrap("TempHumidBasement"),(Byte) (0));
 //BA.debugLineNum = 121;BA.debugLine="MQTT.Subscribe(\"HumidityAddValue\", 0)";
b4r_main::_mqtt->Subscribe(be_ann53_4.wrap("HumidityAddValue"),(Byte) (0));
 //BA.debugLineNum = 122;BA.debugLine="ReadSensor";
_readsensor();
 };
...
const UInt cp = B4R::StackMemory::cp;
B4R::Object be_ann59_8;
B4R::B4RString be_ann60_3;
B4R::B4RString be_ann61_3;
B4R::B4RString be_ann62_4;
B4R::B4RString be_ann62_6;
B4R::B4RString be_ann64_3;
B4R::B4RString be_ann67_3;
 //BA.debugLineNum = 126;BA.debugLine="Sub mqtt_MessageArrived (Topic As String, Payload(";
 //BA.debugLineNum = 127;BA.debugLine="pin16.DigitalWrite(False)";
b4r_main::_pin16->DigitalWrite(Common_False);
 //BA.debugLineNum = 128;BA.debugLine="Log(\"Message arrived. Topic=\", Topic, \" Payload=\"";
B4R::Common::LogHelper(4,102,F("Message arrived. Topic="),101,_topic->data,102,F(" Payload="),100,be_ann59_8.wrapPointer(_payload));
 //BA.debugLineNum = 130;BA.debugLine="If Topic = \"TempHumidBasement\" Then";
if ((_topic)->equals(be_ann60_3.wrap("TempHumidBasement"))) { 
 //BA.debugLineNum = 131;BA.debugLine="If Payload = \"Restart controller\" Then";
if ((_payload)->equals((be_ann61_3.wrap("Restart controller"))->GetBytes())) { 
 //BA.debugLineNum = 132;BA.debugLine="MQTT.Publish(\"TempHumidBasement\",\"*Restarting r";
b4r_main::_mqtt->Publish(be_ann62_4.wrap("TempHumidBasement"),(be_ann62_6.wrap("*Restarting relay by remote"))->GetBytes());
 //BA.debugLineNum = 133;BA.debugLine="ESP.Restart";
b4r_main::_esp->Restart();
 }else if((_payload)->equals((be_ann64_3.wrap("Read weather"))->GetBytes())) { 
 //BA.debugLineNum = 135;BA.debugLine="ReadWeather(1)";
_readweather((Byte) (1));
 };
 }else if((_topic)->equals(be_ann67_3.wrap("HumidityAddValue"))) { 
...
const UInt cp = B4R::StackMemory::cp;
 //BA.debugLineNum = 202;BA.debugLine="Public Sub ReadSensor";
 //BA.debugLineNum = 204;BA.debugLine="RunNative(\"setup\",Null)";
Common_RunNative(setup,Common_Null);
 //BA.debugLineNum = 205;BA.debugLine="ReadWeather(0)";
_readweather((Byte) (0));
...
B4R::B4RString be_ann107_12;
B4R::B4RString be_ann107_16;
B4R::B4RString be_ann107_20;
B4R::B4RString be_ann107_24;
B4R::B4RString be_ann107_28;
B4R::B4RString be_ann107_32;
B4R::B4RString be_ann107_36;
B4R::B4RString be_ann107_54;
B4R::B4RString be_ann107_72;
B4R::B4RString be_ann107_90;
B4R::B4RString be_ann107_108;
B4R::B4RString be_ann107_126;
B4R::B4RString* be_ann107_143e1[25];
B4R::Array be_ann107_143e2;
...
_localstate = be_ann95_2.wrap("OK");
 break; }
case 1: {
 //BA.debugLineNum = 173;BA.debugLine="localstate = \"TIMEOUT\"";
_localstate = be_ann97_2.wrap("TIMEOUT");
 break; }
case 2: {
 //BA.debugLineNum = 176;BA.debugLine="localstate = \"CHECKSUM\"";
_localstate = be_ann99_2.wrap("CHECKSUM");
 break; }
}
;
 //BA.debugLineNum = 179;BA.debugLine="If WiFi.IsConnected Then";
if (b4r_main::_wifi->getIsConnected()) { 
 //BA.debugLineNum = 180;BA.debugLine="If localstate = \"OK\" And IsNumber(DHT22Temp) The";
if ((_localstate)->equals(be_ann102_3.wrap("OK")) && B4R::__c->IsNumber(B4R::B4RString::fromNumber((Double)(b4r_main::_dht22temp)))) { 
 //BA.debugLineNum = 182;BA.debugLine="timelib.initialize(\"pool.ntp.org\",0)";
b4r_main::_timelib->initialize(be_ann103_4.wrap("pool.ntp.org"),0);
 //BA.debugLineNum = 183;BA.debugLine="timestamp = timelib.timestamp";
b4r_main::_timestamp = b4r_main::_timelib->timestamp();
 //BA.debugLineNum = 184;BA.debugLine="If timestamp <> 0 Then";
if (b4r_main::_timestamp!=0) { 
 //BA.debugLineNum = 185;BA.debugLine="Dim s As String";
_s = B4R::B4RString::EMPTY;
 //BA.debugLineNum = 186;BA.debugLine="s = JoinStrings(Array As String(localstate,\"|\"";
_s = B4R::__c->JoinStrings(be_ann107_143e2.create(be_ann107_143e1,25,100,_localstate,be_ann107_12.wrap("|"),B4R::B4RString::fromNumber((Double)(b4r_main::_dht22temp)),be_ann107_16.wrap("|"),B4R::B4RString::fromNumber((Double)(b4r_main::_dht22hum)),be_ann107_20.wrap("|"),B4R::B4RString::fromNumber((Long)(b4r_main::_dht22perception)),be_ann107_24.wrap("|"),B4R::B4RString::fromNumber((Long)(b4r_main::_dht22comfortstatus)),be_ann107_28.wrap("|"),B4R::B4RString::fromNumber((Double)(b4r_main::_dht22heatindex)),be_ann107_32.wrap("|"),B4R::B4RString::fromNumber((Double)(b4r_main::_dht22dewpoint)),be_ann107_36.wrap("|"),B4R::__c->NumberFormat(b4r_main::_timelib->getyear(b4r_main::_timestamp),(Byte) (2),(Byte) (0)),be_ann107_54.wrap("-"),B4R::__c->NumberFormat(b4r_main::_timelib->getmonth(b4r_main::_timestamp),(Byte) (2),(Byte) (0)),be_ann107_72.wrap("-"),B4R::__c->NumberFormat(b4r_main::_timelib->getday(b4r_main::_timestamp),(Byte) (2),(Byte) (0)),be_ann107_90.wrap("|"),B4R::__c->NumberFormat(b4r_main::_timelib->gethour(b4r_main::_timestamp),(Byte) (2),(Byte) (0)),be_ann107_108.wrap(":"),B4R::__c->NumberFormat(b4r_main::_timelib->getminute(b4r_main::_timestamp),(Byte) (2),(Byte) (0)),be_ann107_126.wrap(":"),B4R::__c->NumberFormat(b4r_main::_timelib->getseconds(b4r_main::_timestamp),(Byte) (2),(Byte) (0))));
 //BA.debugLineNum = 190;BA.debugLine="Log(\"TempHumidBasement to MQTT: \",s)";
B4R::Common::LogHelper(2,102,F("TempHumidBasement to MQTT: "),101,_s->data);
 //BA.debugLineNum = 191;BA.debugLine="MQTT.Publish(\"TempHumidBasement\",s)";
b4r_main::_mqtt->Publish(be_ann109_4.wrap("TempHumidBasement"),(_s)->GetBytes());
 };
 };
 };
 //BA.debugLineNum = 197;BA.debugLine="If tag = 0 Then";
if (_tag==0) { 
 //BA.debugLineNum = 198;BA.debugLine="CallSubPlus(\"ReadWeather\",60000,0)";
